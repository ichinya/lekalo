...
product 0.1.28 (annotated tag `v0.1.28` on `967bf52`); issue #62 now carries
prospective product 0.1.29. Issue #8 published product 0.1.6 at `5580b83`. Product versions,
