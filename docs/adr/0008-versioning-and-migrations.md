...
product 0.1.25 (annotated tag `v0.1.25` on `e627fe5`); issue #18 now
carries prospective product 0.1.26. Issue #8 published product 0.1.6 at `5580b83`. Product versions,
