...
product 0.1.27 (annotated tag `v0.1.27` on `ef7680d`); issue #25 now
carries prospective product 0.1.28. Issue #8 published product 0.1.6 at `5580b83`. Product versions,
