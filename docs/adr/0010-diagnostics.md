...
in every accepted path (issue #13 published product 0.1.11 at `007c01d`; issue #12 published product 0.1.10 at `fdfbcb5`); this issue carried prospective product 0.1.9 in
