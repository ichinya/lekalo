...
- [`contracts/diagnostic-registry.v1.11.0.json`](../contracts/diagnostic-registry.v1.11.0.json) — the current registry instance,
- [`contracts/diagnostic-registry.v1.10.0.json`](../contracts/diagnostic-registry.v1.10.0.json) — the frozen predecessor instance.
