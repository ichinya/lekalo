...
- [`contracts/diagnostic-registry.v1.16.0.json`](../contracts/diagnostic-registry.v1.16.0.json) — the current registry instance,
- [`contracts/diagnostic-registry.v1.14.0.json`](../contracts/diagnostic-registry.v1.14.0.json) — the accepted predecessor instance.
