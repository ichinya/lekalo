...
0.2.3, Model 1.0.0, IR 0.1.0 and diagnostic registry 1.13.0 remain
independent version lines. Registry 1.13.0 retains the target entries
introduced in 1.10.0 and the requirements entries introduced in 1.11.0,
and adds the init adoption entries.
