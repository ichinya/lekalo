...
| Introspection evidence (adapter-produced) | `dev.lekalo.storage-observation@0.4.0` | `contracts/storage-observation.schema.v0.4.0.json` |
...
`storage-observation` evidence document per exchange: the
...
lekalo storage validate-engine PATH
