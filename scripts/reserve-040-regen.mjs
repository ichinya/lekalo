// One-off issue #70 reserve regeneration recipe. Repeats the accepted
...
// target-protocol contract is still 0.3.2; the transport-http family
// ships at 0.4.0 (the reserved product generation, issue #70).
