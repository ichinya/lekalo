...
const schema = read("contracts/validation-profile.schema.v0.2.16.json");
const registry = read("contracts/diagnostic-registry.v0.2.16.json");
const profiles = [
  ["contracts/validation-profile.default.v0.2.16.json", "default"],
  ["contracts/validation-profile.strict.v0.2.16.json", "strict"],
