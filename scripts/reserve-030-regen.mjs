#!/usr/bin/env node
// One-off issue #43 section-8 regeneration recipe (plan section 8, step 2).
// Uses only the existing trusted synthetic adapters; writes the named
// goldens and the two digest constants, and puts fixture execution in new
