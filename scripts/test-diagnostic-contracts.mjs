...
if (!isAdditive(registry, registry113)) fail("predecessor-entry-drift");
const profileAdditions = registry.entries.filter((entry) => !registry113.entries.some((old) => old.id === entry.id));
if (
