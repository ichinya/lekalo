//! Storage-projection diagnostics routed through the accepted #11
//! contract (issue #65).
//!
//! Every attachment failure is one registered `storage.*` rule
...
pub(crate) const INPUT_INVALID: &str = "storage.input-invalid";
/// The registered rule for a malformed domain entity record.
pub(crate) const DOMAIN_INVALID: &str = "storage.domain-invalid";
/// The registered rule for a relation semantic violation.
pub(crate) const RELATION_INVALID: &str = "storage.relation-invalid";
/// The registered rule for a malformed projection or table record.
pub(crate) const PROJECTION_INVALID: &str = "storage.projection-invalid";
/// The registered rule for an incoherent projection-to-domain mapping.
pub(crate) const MAPPING_INVALID: &str = "storage.mapping-invalid";
/// The registered rule for an impossible attachment comparison.
pub(crate) const DIFF_INVALID: &str = "storage.diff-invalid";
/// The registered rule for the canonical payload bound.
pub(crate) const EXPORT_LIMIT: &str = "storage.export-limit";
...
/// registered domain, relation, projection, or mapping rule.
...
/// The fatal set for one attachment comparison refusal.
