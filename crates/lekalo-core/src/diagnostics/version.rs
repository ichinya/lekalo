...
/// family LEK-NGT-001..014) -> 0.4.0 (issues #85, #70, #45, and #117:
/// the `nfr.*` family LEK-NFR-001..013, the reserved `transport.*`
/// family LEK-TRN-001..009, and the additive `storage.profile-*`
/// family LEK-SEP-001..005, all at the reserved 0.4.0 product
/// generation; issue #45 ships no new diagnostic families).
