...
const GOLDEN_DIGEST: &str =
    "sha256:d8cf61bd3a5d1b01dfbe847f8f84907aaac411bc933a4b2f545d2fed659ccfae";
const MULTI: &[u8] =
...
fn golden_contract_only_lock_parses_and_matches_its_independent_digest() {
    ...
    assert_eq!(lock.core_version().as_str(), "0.1.22");
...
fn wire_refusals_carry_the_closed_reason_codes() {
    ...
    let cases = [
        ...
        (
            "v-prefixed version",
            tampered("\"version\":\"0.1.22\"", "\"version\":\"v0.1.9\""),
            "lock.schema-invalid",
        ),
        (
            "build metadata version",
            tampered("\"version\":\"0.1.22\"", "\"version\":\"0.1.9+meta\""),
            "lock.schema-invalid",
        ),
        (
            "range version",
            tampered("\"version\":\"0.1.22\"", "\"version\":\"^0.1\""),
            "lock.schema-invalid",
        ),
        (
            "BOM prefix",
